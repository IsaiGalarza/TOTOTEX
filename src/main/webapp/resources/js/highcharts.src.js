...
error = function (code, stop) {
	var msg = 'Highcharts error #' + code + ': www.MediPiel/errors/' + code;
	if (stop) {
		throw msg;
	}
	// else ...
...
defaultOptions = {
	...
	global: {
		useUTC: true,
		//timezoneOffset: 0,
		canvasToolsURL: 'http://code.MediPiel/4.0.4/modules/canvas-tools.js',
		VMLRadialGradientURL: 'http://code.MediPiel/4.0.4/gfx/vml-radial-gradient.png'
	},
	chart: {
		//animation: true,
		//alignTicks: false,
