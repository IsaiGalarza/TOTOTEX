...
/**
 * Clasificacion de Prendas Ej: HOMBRE - MUJER - JUVENIL - KIDS
 * @author mauriciobejaranorivera
 *
 */
@Named(value="clasificacionPrendaController")
@ConversationScoped
public class ClasificacionPrendaController implements Serializable{
	...
	//LIST
	private List<Atributo> listaClasificacionPrenda;
	...
	private void newEntity(){
		...
		listaClasificacionPrenda = atributoRepository.findAllOrderedByParameter("id");
	}
	...
	public List<Atributo> getListaClasificacionPrenda() {
		return listaClasificacionPrenda;
	}

	public void setListaClasificacionPrenda(List<Atributo> listaClasificacionPrenda) {
		this.listaClasificacionPrenda = listaClasificacionPrenda;
	}
