...
@WebServlet("/ReportReciboLavanderia")
public class ReportReciboLavanderia extends HttpServlet {
        ...
        try {
        	...
        	try { 
        		...
        		if(reciboLavanderia!=null){
        			...
        			parameters.put("pIdProcesoLavanderia", ID_FT);
        			parameters.put("pDirPhoto", logo);
        			parameters.put("pUsuario", pUsuario);
        			
        			String rutaReporte = urlPath+"resources/report/produccion/recibo-lavanderia.jasper";
