...
@Entity
@XmlRootElement
@Table(name = "ficha_detalle_insumo_acabado", schema = "public")
public class FichaDetalleInsumoAcabado implements Serializable{
	...
	public boolean equals(Object obj) {
		...
		FichaDetalleInsumoAcabado other = (FichaDetalleInsumoAcabado) obj;
		if (id == null) {
			if (other.id != null) {
				return false;
			}
	...
	public String toString() {
		return "FichaDetalleInsumoAcabado [id=" + id + ", producto=" + producto
