 ...
 */
@Entity
@Table(name = "proceso_lavanderia", schema = "public")
public class ProcesoLavanderia implements Serializable {	
	...
	@ManyToOne
	@JoinColumn(name = "id_recibo_lavanderia",nullable=true)
	...
	public ProcesoLavanderia() {
		super();
		this.id = 0;
		this.reciboLavanderia = new ReciboLavanderia();
