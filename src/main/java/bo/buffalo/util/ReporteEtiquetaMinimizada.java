...
@WebServlet("/EtiquetaMinimizada")
public class ReporteEtiquetaMinimizada extends HttpServlet {
...
//        FacesContext.getCurrentInstance().responseComplete();
        ...
        try { 
        		...
        		String rutaReporte = urlPath+"resources/report/EtiquetaMinimizada.jasper";
...
//        		JasperExportManager.exportReportToPdfFile(jasperPrint,"C:/etiquetas/Etiqueta+"+pCodigoPre+"-"+pNombreElaborado+".pdf");
    			...
    			e.printStackTrace();
    			System.out.println("Error al ingresar ReporteEtiquetaMinimizada: " + e.getMessage());
