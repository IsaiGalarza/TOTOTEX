...
public class ReporteLibroVentasSFV extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request,
        ...
        try { 
    		...
    		System.out.println("LIBRO VENTAS SFV GENERANDO =============>  pGestion: "+pGestion+", pMes: "+pMes);
    		...
    		String rutaReporte = urlPath+"resources/report/libro-ventas.jasper";
...
//    		JasperExportManager.exportReportToPdfFile(jasperPrint,"C:/etiquetas/Etiqueta+"+pCodigoPre+"-"+pNombreElaborado+".pdf");
			...
			e.printStackTrace();
			System.out.println("Error en ReporteLibroVentasSFV: " + e.getMessage());
