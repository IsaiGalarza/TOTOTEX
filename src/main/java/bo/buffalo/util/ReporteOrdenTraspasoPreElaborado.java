...
@WebServlet("/ReporteOrdenTraspasoPreElaborado")
public class ReporteOrdenTraspasoPreElaborado extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request,
		...
		try {
			...
			String rutaReporte = urlPath
					+ "resources/report/OrdenesIngreso/reportTraspasoPreElaborado.jasper";
