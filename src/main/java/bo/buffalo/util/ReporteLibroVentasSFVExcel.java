...
@WebServlet("/ReporteLibroVentasSFVExcel")
public class ReporteLibroVentasSFVExcel extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request,
        ...
        try { 
    		...
    		System.out.println("LIBRO VENTAS SFV EXCEL GENERANDO =============>  pGestion: "+pGestion+", pMes: "+pMes);
    		...
    		String rutaReporte = urlPath+"resources/report/libro-ventas-excel.jasper";
...
//			   exporterXLS.setParameter(JRXlsExporterParameter.IS_AUTO_DETECT_CELL_TYPE, Boolean.TRUE); 
			   ...
			   response.setHeader("Content-disposition","attachment; filename=\"LibroVentasSFV.xls\"");
			...
			e.printStackTrace();
			System.out.println("Error en ReporteLibroVentasSFVExcel: " + e.getMessage());
