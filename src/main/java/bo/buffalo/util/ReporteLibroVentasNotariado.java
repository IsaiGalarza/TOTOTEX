...
public class ReporteLibroVentasNotariado extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request,
        ...
        try { 
    		...
    		System.out.println("LIBRO VENTAS NOTARIADO GENERANDO =============>  pGestion: "+pGestion+", pMes: "+pMes+", pSucursal: "+pSucursal);
    		...
    		String rutaReporte = urlPath+"resources/report/libro-ventas-notariado.jasper";
