...
@WebServlet("/ReporteLibroComprasDaVinci")
public class ReporteLibroComprasDaVinci extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request,
        ...
        try { 
    		...
    		System.out.println("LIBRO COMPRAS DA VINCI GENERANDO =============>  pGestion: "+pGestion+", pMes: "+pMes);
    		...
    		String rutaReporte = urlPath+"resources/report/libro-compras-davinci.jasper";
...
//			   exporterXLS.setParameter(JRXlsExporterParameter.IS_AUTO_DETECT_CELL_TYPE, Boolean.TRUE); 
			   ...
			   response.setHeader("Content-disposition","attachment; filename=\"LibroComprasDaVinci.xls\"");
