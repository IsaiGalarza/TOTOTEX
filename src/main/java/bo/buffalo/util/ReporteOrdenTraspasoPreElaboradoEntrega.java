...
@WebServlet("/ReporteOrdenTraspasoPreElaboradoEntrega")
public class ReporteOrdenTraspasoPreElaboradoEntrega extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request,
		...
		try {
			...
			String rutaReporte = urlPath
					+ "resources/report/OrdenesIngreso/reportTraspasoPreElaboradoEntrega.jasper";
