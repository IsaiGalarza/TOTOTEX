...
@WebServlet("/ReporteInventarioAlmacen")
public class ReporteInventarioAlmacen extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request,
		...
		try {
			...
			System.out.println("pSucursal: " + pIdAlmacen);
			...
			String rutaReporte=""; 
			if (pEstado.equals("DETALLADO")) {				
				rutaReporte = urlPath
						+ "resources/report/Inventario/reportInventarioPorAlmacen.jasper";
			}else if (pEstado.equals("RESUMIDO")) {
				rutaReporte = urlPath
						+ "resources/report/Inventario/reportInventarioProductoAlmacen.jasper";
			}
